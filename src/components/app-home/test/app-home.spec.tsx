...
describe('app-home', () => {
  ...
  let fetchMock;
  beforeEach(async () => {
      fetchMock = jest.spyOn(global, 'fetch').mockReturnValue( Promise.resolve({
...
// function changeBooleanTotoBeenEdited(x: Readonly<ITodo>) {
//       x = null;
//     }
//   it('should return null the ITodo related to modal', async () => {
//     const toReturnNull = changeBooleanTotoBeenEdited(TODO_01)
//     expect(toReturnNull).toReturn(null);
//   });

  // it('should listen [cancel-modal] event in edit-todo component and cancel the modal of edit-todo', async () => {
  //   const todoToCancel = new CustomEvent<ITodo>('cancel-modal', {
  //     detail: TODO_01
  //   });
  //   expect(todoToCancel.detail).toHaveBeenCalled();
  // });
